...
@section('content')
        ...
        <div class="content bas d-none d-md-block">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-outline-warning" href="{{route('inscription')}}"><i class="fas fa-pencil-alt"></i>
                        Inscrivez-vous,
                        c'est gratuit</a>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="card border-0 transform-on-hover">
                            ...
                            <div class="card-body cardBodyNone">
                                ...
                                <a href="{{asset($media->url_media)}}"
                                   class="btn btn-sm btn-outline-warning"><small><i class="fas fa-eye"></i> Zoom</small>
                                </a>
                                ...
                                <form
                                    ...
                                    <button
                                        ...
                                        <small><i class="fas fa-ban"></i> Bannir</small>
                                    </button>
                                </form>
                                <?php endif; ?>
                            </div>
    ...
    <div class="embed-responsive embed-responsive-16by9">
        <video preload="none" poster="{{asset('/img/adherent/medias/tutorial.jpg')}}" controls="true">
            <source src="{{asset('/img/adherent/medias/tutorial.mp4')}}" alt="Photographie de paysage"
                    type="video/mp4"/>
        </video>
        <div class="content haut d-none d-md-block">
