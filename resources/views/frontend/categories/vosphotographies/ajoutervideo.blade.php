...
@section('title')
    JusteUnRegard - Ajouter des tutoriels
@endsection
            ...
            <div class="card-body">
                <form action="{{route('ajoutervideo')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="url_media" class="col-4 col-form-label">Télécharger votre tutoriel</label>
                        <div class="col-8">
                            ...
                            <p><strong>Pour information :</strong> La taille du tutoriel est limitée à 500 Mo.</p>
